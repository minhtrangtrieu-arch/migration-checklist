...
var steps = [
  {
    ...
    desc: 'Match your exported data to UpPromote\u2019s CSV template. At minimum: name, email, and commission rate. Clean up duplicates and fix formatting issues before import.',
    links: [{ label: 'Download CSV template', href: '#', download: true }]
  },
  {
    phase: 'Visualize your program', phaseTime: 'Week 1',
    title: 'Create your first program and set a commission rule',
